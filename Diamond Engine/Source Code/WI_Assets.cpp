...
#pragma endregion
		...
		{																																	//This prevents mesh removal because mesh files have no dirName
			if ((EngineExternal->moduleResources->GetTypeFromLibraryExtension(selectedFile->libraryPath.c_str()) != Resource::Type::UNKNOWN || selectedFile->isDir) && strcmp(selectedFile->dirName.c_str(), "Meshes") != 0) 
			{
